...
## 1. References Identified on Your Machine
During the search, we located several critical reference documents in your local OneDrive sync cache folder:
`[how-relap-does-it](file:///Users/cgg-mac/Library/Group%20Containers/UBF8T346G9.OneDriveStandaloneSuite/OneDrive%20-%20U.S.%20NRC.noindex/OneDrive%20-%20U.S.%20NRC/SNAP/pipe-force-calcs-for%20trace/how-relap-does-it/)`

### Key Reference Files
1. **R5FORCE User Manual**: 
   * **Path**: [R5FORCEMOD3-EGG-EAST-9232-6341078.pdf](file:///Users/cgg-mac/Library/Group%20Containers/UBF8T346G9.OneDriveStandaloneSuite/OneDrive%20-%20U.S.%20NRC.noindex/OneDrive%20-%20U.S.%20NRC/SNAP/pipe-force-calcs-for%20trace/how-relap-does-it/r5force/R5FORCEMOD3-EGG-EAST-9232-6341078.pdf)
...
2. **RELAP5/MOD3 Code Manual (Volume 5: User's Guidelines)**:
   * **Path**: [NUREGCR-5535-RELAP5MOD3CodeMAN-VOL5-ML110380261.pdf](file:///Users/cgg-mac/Library/Group%20Containers/UBF8T346G9.OneDriveStandaloneSuite/OneDrive%20-%20U.S.%20NRC.noindex/OneDrive%20-%20U.S.%20NRC/SNAP/pipe-force-calcs-for%20trace/how-relap-does-it/r5force/NUREGCR-5535-RELAP5MOD3CodeMAN-VOL5-ML110380261.pdf)
...
3. **NuScale Short-Term Transient Analysis (HELB)**:
   * **Path**: [NUSCALE-HELB-R5force-ref-ML17005A132.pdf](file:///Users/cgg-mac/Library/Group%20Containers/UBF8T346G9.OneDriveStandaloneSuite/OneDrive%20-%20U.S.%20NRC.noindex/OneDrive%20-%20U.S.%20NRC/SNAP/pipe-force-calcs-for%20trace/how-relap-does-it/r5force/NUSCALE-HELB-R5force-ref-ML17005A132.pdf)
...
4. **Fauske & Associates Technical Bulletin N-15-04**:
   * **Path**: [Tech_bulletin_N-15-04.pdf](file:///Users/cgg-mac/Library/Group%20Containers/UBF8T346G9.OneDriveStandaloneSuite/OneDrive%20-%20U.S.%20NRC.noindex/OneDrive%20-%20U.S.%20NRC/SNAP/pipe-force-calcs-for%20trace/how-relap-does-it/Tech_bulletin_N-15-04.pdf)
...
1. **Extract TRACE Hydrodynamics**:
   * Use the existing python utility [`xtvReader.py`](file:///Users/cgg-mac/TRACE-CmakeBuild/Scripts/xtvReader.py) (found in your `TRACE-CmakeBuild` repo) to parse the TRACE binary XTV output files (`Steady.xtv`, `Transient.xtv`, etc.).
