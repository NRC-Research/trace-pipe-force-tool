...
| **VAL-005** | EPRI Safety/Relief Valve | Loop seal / valve transient dynamic loads | R5FORCE benchmark | CF202 peak $-40.3\text{ kN}$ vs $-42.4\text{ kN}$; slug burst reproduced | **PH1 PARTIAL / PH2 PASS** (timing exact; CF202 -5%; wet case qualitative) |
